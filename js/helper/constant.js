const mainUserPage = 'focus-flow-main';
const mainQnAPage = 'focus-flow-qna';
const mainResultPage = 'focus-flow-result';
const subjectErrorEmpty = 'Subject name cannot be empty.';
